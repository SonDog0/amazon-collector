...
from amazonCollector.search import collector_search ,get_asin_csv, collector_listing, join_listring_search, sql_amazon_csv_insert
...
review_result = collector_review(item='cosmetic', today_datetime=today_datetime, asin_list=asin_list)
